module.exports = {
  "originOnly": {
    ...
    "show [numberOfFrames] similiar": [
      "显示 [numberOfFrames] 个相似的"
    ],
    "collapse [numberOfFrames] similiar": [
      "折叠 [numberOfFrames] 个相似的"
    ],
    "grouped by": [
      "分组依据"
    ],
    ...
    "There was an error while trying to load participants.": [
      "载入参与者时出错。"
    ],
    "View more": [
      "显示更多"
    ...
    "You don't have permission to add a project": [
      "您没有添加项目的权限"
    ],
    ...
    "Send Me Workflow Notifications": [
      "向我发送工作流通知"
    ],
    ...
    "Only admins may change reprocessing settings": [
      "仅管理员可以改变重处理设置"
    ],
    ...
    "Congrats, you have no unresolved issues": [
      "恭喜，您没有未解决的问题。"
    ],
    "Tag": [
      "标签"
    ...
    "Search title and culprit text body": [
      "搜索标题和问题文本正文"
    ],
    "Unable to retrieve values for tag [tagName]": [
      "未能取回标签[tagName]的值"
    ],
    "Select a platform": [
      "选择一个平台"
    ...
    "[author] marked [issue] as resolved": [
      "[author] 将 [issue] 标记为解决"
    ],
    ...
    "[author] marked [issue] as unresolved": [
      "[author] 将 [issue] 标记为了未解决"
    ],
    ...
    "[author] ignored [issue]": [
      "[author] 忽略了 [issue]"
    ],
    "[author] made [issue] public": [
      "[author] 将 [issue] 设置为公开"
    ],
    "[author] made [issue] private": [
      "[author] 将 [issue] 设置为私有"
    ],
    "[author] marked [issue] as a regression in [version]": [
      "[author] 将 [issue] 在 [version] 中标记为回归"
    ],
    "[author] marked [issue] as a regression": [
      "[author] 将 [issue] 标记为回归"
    ],
    "[author] linked [issue] on [provider]": [
      "[author] 在 [provider] 上关联了 [issue]"
    ],
    "[author] saw [link:issue]": [
      "[author] 看到 [link:issue]"
    ],
    "[author] assigned [issue] to #[assignee]": [
      "[author] 分配了 [issue] 给 #[assignee]"
    ],
    "[author] assigned [issue] to themselves": [
      "[author] 分配 [issue] 给 自己"
    ],
    "[author] assigned [issue] to [assignee]": [
      "[author] 分配了 [issue] 给 [assignee]"
    ],
    ...
    "[author] unassigned [issue]": [
      "[author] 取消分配 [issue]"
    ],
    "[author] merged [count] [link:issues]": [
      "[author] 合并[count] [link:issues]"
    ],
    "[author] released version [version]": [
      "[author] 发布了版本 [version]"
    ],
    ...
    "Sorry, no events match your search query.": [
      "抱歉，找不到满足搜索条件的事件。"
    ],
    "There don't seem to be any events yet.": [
      "还没出现任何事件。"
    ],
    "search event id, message, or tags": [
      "搜索事件ID，消息和标签"
    ],
    ...
    "Remove the following organizations": [
      "移除下列组织"
    ],
    ...
    "Configure user feedback reporting feature": [
      "配置用户反馈报告功能"
    ],
    "View and manage a  project's tags": [
      "查看和管理项目标签"
    ],
    "Manage issue ownership rules for a project": [
      "管理项目问题所有者规则"
    ],
    ...
    "Good news! There are no processing issues.": [
      "好消息！没有正在处理的问题。"
    ],
    ...
    "No crashed thread found in crash report": [
      "在崩溃报告中没有找到崩溃线程"
    ],
    ...
    "A system debug information file was missing.": [
      "系统调试信息文件丢失。"
    ],
    "Could not resolve one or more frames in debug information file.": [
      "在调试信息文件中不能解决一个或多个帧。"
    ],
    "Encountered an unprocessable simulator frame.": [
      "遇到无法处理的模拟帧。"
    ],
    "A binary image is referenced that is unknown.": [
      "引用了未知的二进制镜像。"
    ],
    "A proguard mapping file does not contain line info.": [
      "混淆映射文件不包含行信息。"
    ],
    "You must be a project admin to create teams": [
      "只有项目管理员才能创建团队"
    ],
    ...
    "Unable to remove artifact. Please try again.": [
      "无法删除工件，请重试。"
    ],
  ...
  "translatedOnly": {
    ...
    "There was an error encountered during authentication.": [
      "身份验证出错。"
    ],
    ...
    "SAML SSO failed, {reason}": [
      "单点登录SAML SSO失败，{reason}"
    ],
    ...
    "The {name} integration has been enabled.": [
      "{name}集成已启用。"
    ],
    "The {name} integration has been disabled.": [
      "{name}集成已禁用。"
    ],
    ...
    "Path may not contain spaces or quotations": [
      "路径不能包含空格或引号"
    ],
    "Installation": [
      "安装"
    ...
    "Bitbucket Consumer Private Key": [
      "Bitbucket用户私钥"
    ],
    ...
    "Sync Sentry Assignment to Jira": [
      "同步 Sentry 任务至 Jira"
    ],
    ...
    "Sync Jira Assignment to Sentry": [
      "同步 Jira 任务至 Sentry"
    ],
    ...
    "Jira Consumer Private Key": [
      "Jira用户私钥（Jira Consumer Private Key）"
    ],
    ...
    "Sync Sentry Status to Azure DevOps": [
      "同步Sentry状态到Azure DevOps"
    ],
    ...
    "Could not find Azure DevOps project": [
      "没有找到 Azure DevOps 项目"
    ],
    "Azure DevOps Project": [
      "Azure DevOps 项目"
    ],
    "Sync Sentry Assignment to Azure DevOps": [
      "同步 Sentry 任务至 Azure DevOps"
    ],
    ...
    "Sync Sentry Comments to Azure DevOps": [
      "同步Sentry评论到Azure DevOps"
    ],
    "Post comments from Sentry issues to linked Azure DevOps work items": [
      "将 Sentry 问题的评论发布到关联的 Azure DevOps 工作项中"
    ],
    "Sync Azure DevOps Status to Sentry": [
      "同步 Azure DevOps 状态至 Sentry"
    ],
    ...
    "Sync Azure DevOps Assignment to Sentry": [
      "同步 Azure DevOps 任务至 Sentry"
    ],
    ...
    "Stacktrace (most recent call first):": [
      "Stacktrace (最近的调用最先显示)"
    ],
    "Stacktrace (most recent call last):": [
      "Stacktrace (最近的调用最后显示)"
    ],
    "Inactive": [
      "无效的"
    ],
    ...
    "Organization member requested to invite user": [
      "组织成员请求邀请用户"
    ],
    "User requested to join organization": [
      "用户请求加入组织"
    ],
    "Pending Deletion": [
      "等待删除"
    ...
    "The password on your account expired.": [
      "您的帐户的密码已过期"
    ],
    ...
    "Set your account password below.": [
      "在下方设置你的账户密码"
    ],
    ...
    "Crash reports powered by <a href=\\": [
      "崩溃报告生成由 <a href=\\"
    ],
    "Bitbucket-Server Setup": [
      "Bitbucket 服务安装"
    ],
    "Connect Sentry with your App": [
      "连接Sentry到您的应用"
    ],
    ...
    "Step 2: Connect Sentry with your App": [
      "步骤2：连接Sentry到你的应用"
    ],
    ...
    "Step 1: Create a Sentry App in GitLab": [
      "步骤1：在GitLab中创建一个Sentry应用"
    ],
    ...
    "Microsoft Teams Expired Link": [
      "微软团队过期链接"
    ],
    "Microsoft Teams Linked": [
      "微软团队链接"
    ],
    ...
    "Unlink with Microsoft Teams": [
      "取消与微软团队的链接"
    ],
    "Microsoft Teams Unlinked": [
      "微软团队未链接"
    ],
    ...
    "Configure Azure DevOps to use with Sentry.": [
      "配置Azure DevOps使用Sentry。"
    ],
    ...
    "The date the password was changed last.": [
      "上一次密码修改时间"
    ],
    "date joined": [
      "加入日期"
    ...
    "Your email (%s) has already been verified.": [
      "你的电子邮件 (%s) 已确认。"
    ],
    ...
    "I clicked on 'X' and then hit 'Confirm'": [
      "我点了 'X' 然后触发了 '提交'"
    ],
    "The SSO feature is not enabled for this organization.": [
      "该组织未启用 SSO 登录功能。"
    ],
    "SSO authentication has been disabled.": [
      "SSO 登录已禁用。"
    ],
    ...
    "Error fetching team key transactions": [
      "提取团队关键事务时出错"
    ],
    "Saving changes…": [
      "正在保存更改..."
    ],
    "Unable to update key transaction": [
      "无法更新键事务"
    ],
    "Error transferring [project]. [message]": [
      "出现传输错误 [project]. [message]"
    ],
    "Restoring Release…": [
      "正在恢复发布版本..."
    ],
    ...
    "Release could not be be restored.": [
      "发布版本无法恢复"
    ],
    "Archiving Release…": [
      "正在归档发布版本..."
    ],
    "Release was successfully archived.": [
      "发布版本已成功归档"
    ],
    "Release could not be be archived.": [
      "发布版本无法归档"
    ],
    "Copy to Clipboard": [
      "复制到剪贴板"
    ...
    "Based on [commit:commit data]": [
      "基于[提交: 提交数据]"
    ],
    "Matching Issue Owners Rule": [
      "匹配问题所有者规则"
    ],
    ...
    "[currentStepCount] of [totalStepCount]": [
      "[当前步数] 的 [总步数]"
    ],
    ...
    "Successfully updated organization settings": [
      "已成功更新组织设置"
    ],
    ...
    "Insufficient permissions to preview attachments": [
      "预览附件的权限不足"
    ],
    ...
    "Non-contributing variant: %s": [
      "无贡献变体： %s"
    ],
    "Non-contributing variant": [
      "无贡献变体"
    ],
    "Nothing": [
      "无"
    ...
    "There are no breadcrumbs to be displayed": [
      "没有要显示的面包屑"
    ],
    "Search breadcrumbs": [
      "搜索痕迹导航"
    ...
    "No relevant stack trace has been found!": [
      "未找到相关的堆栈跟踪！"
    ],
    "No app only stack trace has been found!": [
      "未找到仅限应用程序的堆栈跟踪！"
    ],
    ...
    "There are no debug files to be displayed": [
      "没有要显示的调试文件"
    ],
    "Debug File Candidates": [
      "调试文件候选项"
    ],
    ...
    "An error occurred while deleting the debug file.": [
      "删除调试文件时出错。"
    ],
    "Image": [
      "图像"
    ...
    "This event cannot be reprocessed": [
      "无法重新处理此事件"
    ],
    ...
    "Stack trace configuration saved.": [
      "堆栈跟踪配置已保存。"
    ],
    ...
    "Inline frame, found by stack scanning": [
      "内联框架，通过堆栈扫描找到"
    ],
    "Inline frame": [
      "内联框架"
    ...
    "The symbol was not found within the debug file.": [
      "在调试文件中找不到该符号。"
    ],
    ...
    "Loading embedded transaction": [
      "加载嵌入式事务"
    ],
    "Error loading embedded transaction": [
      "加载嵌入式事务时出错"
    ],
    "View Children": [
      "查看儿童"
    ...
    "[numOfSpans] hidden span": [
      "[spansnumOfSpans] hidden span"
    ],
    "[numOfSpans] hidden spans": [
      "[spansnumOfSpans] hidden spans"
    ],
    ...
    "There is no trace for this transaction": [
      "此事务没有痕迹"
    ],
    "id": [
      "编号"
    ...
    "Unsymbolicated version not available": [
      "无符号化版本不可用"
    ],
    "Minified version not available": [
      "缩小版本不可用"
    ],
    "Only full version available": [
      "仅提供完整版"
    ],
    "Most Relevant": [
      "最相关"
    ...
    "Download raw stack trace file": [
      "下载原始堆栈跟踪文件"
    ],
    "Options": [
      "选项"
    ],
    "There was an error rendering the title": [
      "呈现标题时出错"
    ],
    ...
    "(Secret Access Key unchanged)": [
      "（秘密访问键不变）"
    ],
    "Client Email": [
      "客户电子邮箱"
    ],
    "Email address of the GCS service account.": [
      "GCS 服务帐户的电子邮件地址。"
    ],
    ...
    "[inviteRequests] pending approval": [
      "[邀请请求] 待批准"
    ],
    ...
    "Number of events to be reprocessed": [
      "要重新处理的事件数"
    ],
    ...
    "[admin] access to [resources] resources": [
      "[管理员] 对 [资源] 资源的访问权限"
    ],
    "Authored By %s": [
      "作者 %s"
    ],
    "[read] access to [resources] resources": [
      "[读取] 访问 [资源] 资源"
    ],
    "Request to publish %s successful.": [
      "请求发布 %s 成功。"
    ],
    "Request to publish [app] fails. [detail]": [
      "请求发布 [应用] 失败。[详细]"
    ],
    "Publish Request Questionnaire": [
      "发布请求调查问卷"
    ],
    "Request Publication": [
      "请求发布"
    ],
    "Team request sent for approval": [
      "团队请求已发送以供审批"
    ],
    "Edit Widget": [
      "编辑小部件"
    ...
    "[requisite] before completing this task": [
      "[必需] 在完成此任务之前"
    ],
    "Start": [
      "开始"
    ...
    "Send a test email to %s": [
      "发送一封测试邮件到 %s"
    ],
    "%s's account has been deleted.": [
      "%s的账号已被删除。"
    ],
    "%s's account has been deactivated.": [
      "%s的账号已被停用。"
    ],
    "Editing user: %s": [
      "编辑用户: %s"
    ...
    "Use STARTTLS? (exclusive with SSL)": [
      "使用 STARTTLS？（与SSL互斥）"
    ],
    "Use SSL? (exclusive with STARTTLS)": [
      "使用 SSL？（与STARTTLS互斥）"
    ],
    "Edit Alert Rule": [
      "编辑告警规则"
    ...
    "Uploaded debug information files": [
      "上传的调试信息文件"
    ],
    "There are no debug symbols that match your search.": [
      "没有搜索到匹配的调试符号。"
    ],
    "Successfully added built-in repository": [
      "已成功添加内置仓库"
    ],
    "Successfully removed built-in repository": [
      "已成功移除内置仓库"
    ],
    "Select built-in repository": [
      "选择内置仓库"
    ],
    "Delete Repository": [
      "删除仓库"
